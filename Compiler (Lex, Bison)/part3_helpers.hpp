...
typedef struct {
	...
	vector<string> paramValues; // Function's parameters value
...
static int currentOffset = 0;  // Start memory allocation from offset 0
static int previousOffset = 0;
static vector<string> currentParamsOrder; // Order of parameters in function definition
static vector<string> tmpParamsOrder; // Order of parameters in function definition
static vector<string> currentOptionalParamsOrder; // Order of optional parameters in function definition
static vector<string> tmpOptionalParamsOrder; // Order of optional parameters in function definition
static int currentIntRegister = 3;
static int currentFloatRegister = 3;
